...
export class MapTools extends WebMapPlugin<{
  ...
  private _init () {
    this._toolPool
      ...
      .set('draw-point', new DrawTool(this.map, this.view, { drawType: 'point' }))
      .set('draw-line', new DrawTool(this.map, this.view, { drawType: 'line' }))
      .set('draw-line-faster', new DrawTool(this.map, this.view, { drawType: 'line-faster' }))
      .set('draw-polyline', new DrawTool(this.map, this.view, { drawType: 'polyline' }))
      .set('draw-polygon', new DrawTool(this.map, this.view, { drawType: 'polygon' }))
      .set('draw-rectangle', new DrawTool(this.map, this.view, { drawType: 'rectangle' }))
      .set('draw-rectangle-faster', new DrawTool(this.map, this.view, { drawType: 'rectangle-faster' }))
      .set('draw-circle', new DrawTool(this.map, this.view, { drawType: 'circle' }))
      .set('draw-circle-faster', new DrawTool(this.map, this.view, { drawType: 'circle-faster' }))
